...
public class HorarioController {
	@Autowired
	private IHorarioService mService;
	
	@RequestMapping("/")
	public String irCategoria(Map<String, Object> model) {
		model.put("listaHorarios", mService.listar());
		return "listHorario";
	}
	...
	public String registrar(@ModelAttribute @Valid Horario objCat, BindingResult binRes, Model model,RedirectAttributes attribute) 
	...
	throws ParseException
	{
		Horario objCat = mService.listarId(id);
		...
		if (objCat == null) {
			...
			model.addAttribute("horario", objCat);
			return "horario";
		}
	}
	...
	public String listar(Map<String, Object> model, @ModelAttribute Horario horario) 
	throws ParseException
	{
		mService.listarId(horario.getId_horario());
		return "listHorario";
	}	
